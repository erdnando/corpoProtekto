...
public class frm242_2 extends AppCompatActivity {
    private String strUUID;
    private String nickname;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_frm242_2);
        ...
        grpRbM1.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                if (checkedId == R.id.radioButton1a) {
                    ...
                    lblTexto6.setVisibility(View.INVISIBLE);
                    etRespuesta6.setVisibility(View.INVISIBLE);
                    Shared200.setP242_2R("1");


                    RadioButton radioButton1a=(RadioButton)findViewById(R.id.radioButton1a) ;
                    Shared200.setP242_25(radioButton1a.getText().toString());
                    ...
                    Shared200.setP242_2R("2");

                    RadioButton radioButton1b=(RadioButton)findViewById(R.id.radioButton1b) ;
                    Shared200.setP242_25(radioButton1b.getText().toString());
                }
    ...
    public void gotoFrm(View view) {
        ...
        if (CheckEditText1.matches("")){
            ...
            Shared200.setP242_21(String.valueOf(CheckEditText1));
        }
        ...
        if (CheckEditText2.matches("")){
            ...
            Shared200.setP242_22(String.valueOf(CheckEditText2));
        }
        ...
        if (CheckEditText3.matches("")){
            ...
            Shared200.setP242_23(String.valueOf(CheckEditText3));
        }
        ...
        if (CheckEditText4.matches("")){
            ...
            Shared200.setP242_24(String.valueOf(CheckEditText4));
        }
        ...
        if (CheckEditText5.matches("")){
            ...
            if(Shared200.getP242_2R().toString().equalsIgnoreCase("2")){
                    ...
                    if (CheckEditText6.matches("")){
                        ...
                        Shared200.setP242_26(String.valueOf(CheckEditText6));
                    }
            }else{
                Shared200.setP242_26("NA");
            }
