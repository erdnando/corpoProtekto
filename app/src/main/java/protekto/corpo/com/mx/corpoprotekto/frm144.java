...
public class frm144 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_frm144);
        ...
        viewer1.setVideoPath("http://74.208.98.86/mx.com.corpo.protekto.api/videos/4.mp4");//http://www.onirikal.com/videos/mp4/lagrama.mp4");
