...
public class frm332_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_frm332_2);
    ...
    public void gotoFrm(View view) {
        ...
        if (editText3.getText().toString().equalsIgnoreCase("")){
            ...
            Shared300.setP332_21(editText3.getText().toString());
        }
        ...
        if (editText4.getText().toString().equalsIgnoreCase("")){
            ...
            Shared300.setP332_22(editText4.getText().toString());
        }
