...
public class frm116 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_frm116);
        ...
        viewer1.setVideoPath("http://74.208.98.86/mx.com.corpo.protekto.api/videos/2.mp4");
    ...
    public void gotoFrm(View view) {
        ...
        Intent newView = null;
        try {
            newView = new Intent(getBaseContext(), Class.forName(getClass().getPackage().getName() +"."+frm));
            newView.putExtra("UUID", strUUID);
            newView.putExtra("nickname", nickname);
            startActivity(newView);
        } catch (ClassNotFoundException e) {
