...
public class frm142 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_frm142);
    ...
    public void gotoFrm(View view) {
        ...
        if (checkedRadioButtonId == -1) {
            ...
            Shared11.set142_1(rdb.getText().toString());
        }
        ...
        if(txtCualCrees.getText().toString().trim().equalsIgnoreCase("")){
            ...
            Shared11.set142_2(txtCualCrees.getText().toString());
        }
        ...
        if(!chk1.isChecked() && !chk2.isChecked() && !chk3.isChecked() && !chk4.isChecked() && !chk5.isChecked()){
            Toast.makeText(this, "Seleccione al menos una opcion en la tercera pregunta !",Toast.LENGTH_LONG).show();
            return;
        }else{

            String resp="";
            if(chk1.isChecked())resp+=chk1.getText()+"|";
            if(chk2.isChecked())resp+=chk2.getText()+"|";
            if(chk3.isChecked())resp+=chk3.getText()+"|";
            if(chk4.isChecked())resp+=chk4.getText()+"|";
            if(chk5.isChecked())resp+=chk5.getText()+"|";
            Shared11.set142_3(resp);
