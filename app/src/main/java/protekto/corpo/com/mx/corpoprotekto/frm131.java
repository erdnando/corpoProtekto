...
public class frm131 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_frm131);
    ...
    public void gotoFrm(View view) {
        ...
        if (checkedRadioButtonId == -1) {
            ...
            Shared11.set131_1(rdb.getText().toString());
        }

        EditText txtCualCrees=(EditText) findViewById(R.id.txtCualCrees);
        if (txtCualCrees.getText().toString().trim().equalsIgnoreCase("")) {
            ...
            Shared11.set131_2(txtCualCrees.getText().toString());
        }

        EditText txtDequeOtro=(EditText) findViewById(R.id.txtDequeOtro);
        if (txtDequeOtro.getText().toString().trim().equalsIgnoreCase("")) {

            // No item selected
            Toast.makeText(this, "Ingrese una respuesta a la tercera pregunta!",Toast.LENGTH_LONG).show();
            return;
        }else{
            Shared11.set131_3(txtDequeOtro.getText().toString());
        }
