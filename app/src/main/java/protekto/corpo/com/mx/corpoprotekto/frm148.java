...
public class frm148 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_frm148);
    ...
    public void gotoFrm(View view) {
        ...
        if (checkedRadioButtonId == -1) {
            ...
            //Shared10.setP148a(String.valueOf(checkedRadioButtonId));
            String name = getResources().getResourceEntryName(checkedRadioButtonId);
            Shared10.setP1481( String.valueOf( name.charAt(name.length()-1))   );
        }
        ...
        if (checkedRadioButtonId2 == -1) {
            ...
            //Shared10.setP148b(String.valueOf(checkedRadioButtonId2));
            String name = getResources().getResourceEntryName(checkedRadioButtonId2);
            Shared10.setP1482( String.valueOf( name.charAt(name.length()-1))   );
        }
        ...
        if(txtEnGralD.getText().toString().trim().equalsIgnoreCase("")){
            ...
            Shared10.setP1483( txtEnGralD.getText().toString()  );
        }
