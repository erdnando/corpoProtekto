...
public class frm332_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_frm332_3);
    ...
    public void gotoFrm(View view) {
        ...
        if (editText3.getText().toString().equalsIgnoreCase("")){
            ...
            Shared300.setP332_31(editText3.getText().toString());
        }
        ...
        if (editText4.getText().toString().equalsIgnoreCase("")){
            ...
            Shared300.setP332_32(editText4.getText().toString());
        }
