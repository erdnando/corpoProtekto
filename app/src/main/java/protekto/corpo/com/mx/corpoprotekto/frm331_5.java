...
public class frm331_5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_frm331_5);
    ...
    public void gotoFrm(View view) {
        ...
        if (editText3.getText().toString().equalsIgnoreCase("")){
            ...
            Shared300.setP331_51(editText3.getText().toString());
        }
        ...
        if (editText4.getText().toString().equalsIgnoreCase("")){
            ...
            Shared300.setP331_52(editText4.getText().toString());
        }
